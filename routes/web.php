...
Route::get('/iqac/iqac-yearly-reports', [PagesController::class, 'iqac_yearly_reports']);
...
Route::get('/research/r-and-d-circular', [PagesController::class, 'r_and_d_circulars']);
