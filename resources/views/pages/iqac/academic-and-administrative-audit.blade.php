...
'value_2' => '',
'value_3' => '',
'page_title' => 'ACADEMIC AND ADMINISTRATIVE AUDIT (AAA)'
])
            ...
            <div class="col-12 my-5">
                <div class="program-description-area">
                    ...
                    <div class="program-credit-area">
                        <h3 class="rts-section-title animated fadeIn">ACADEMIC AND ADMINISTRATIVE AUDIT (AAA)</h3>
                                    ...
                                    <div>
                                        <div class="accordion-body-content">
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <td><a href="javascript:void(0);" onclick="loadPDF('https://firebasestorage.googleapis.com/v0/b/egspj-bumblebees.appspot.com/o/egspec-assets%2Fpdf%2Facademic-and-administrative-audit-aaa.pdf?alt=media&token=e2d1bd79-48bc-4923-8e7a-d652ccdc8b0e')">ACADEMIC AND ADMINISTRATIVE AUDIT (AAA)</a></td>
