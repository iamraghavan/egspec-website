         ...
         <div class="row">
            <div class="col-lg-8">
                                    ...
                                    <div>
                                        <div class="accordion-body-content">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><a href="@blob('academics/departments/undergraduate/mechanical-engineering/student-achievements/student-achievements.pdf')" target="_blank" type="application/pdf" rel="alternate" media='print'> Students Activities </a></td>
                ...
                <div class="iframe-div">
                    <iframe src="https://drive.google.com/viewerng/viewer?embedded=true&amp;url=@blob('academics/departments/undergraduate/mechanical-engineering/student-achievements/student-achievements.pdf')#toolbar=0&amp;scrollbar=0" frameborder="0" scrolling="auto" height="100%" width="100%" style="
