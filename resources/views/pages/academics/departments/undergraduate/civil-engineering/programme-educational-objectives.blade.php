                           ...
                           <table class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Become a successful Civil Engineer to meet the demand-driven needs in the field of Civil Engineering and related disciplines or pursue higher studies or research or become an entrepreneur.</td>
                                </tr>
                                <tr>
                                    <td><strong>PEO2</strong></td>
                                    <td>Analyze and design Civil engineering systems with social awareness and responsibilities.</td>
                                </tr>
                                <tr>
                                    <td><strong>PEO3</strong></td>
                                    <td>Exhibit professionalism, moral values, communication skills, teamwork in their profession, and lifelong learning ability.</td>
                                </tr>
                              </tbody>
                           </table>
                        </div>
