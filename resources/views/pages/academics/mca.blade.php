...
<div class="rts-program rts-section-padding">
    <div class="container">
        <div class="rts-program-single-header">
            <div class="row g-3">
                <div class="col-lg-6">
                    <h3 class="rts-section-title animated fadeIn">MCA Course at MCA EGS Pillay Engineering College</h3>
                </div>
                <div class="col-lg-6">
                    <p class="rts-section-description">The Department of Computer Applications offers a full-time MCA course spanning three years to students at MCA EGS Pillay
                ...
                <div class="col-lg-8">
                    <div class="program-description-area" id="curriculum">
                        <div class="program-big-thumb">
                            <img src="https://egspec.blob.core.windows.net/egspec-assets/mca.jpg" alt="EGSPEC MCA">
                        </div>
                        <div class="program-about">
                            <h4 class="title">About The Program</h4>
                            <p>The Department of Computer Applications offers a full-time MCA course spanning three years to students at MCA EGS Pillay
                            Engineering College.
                            </p>
                            <p>Established in 2001, the course received approval from Bharathidasan University Trichirappalli.
                            In 2003, Anna University, Chennai, recognized and approved the course.
                            Since 2011, the department has been admitting 60 students per academic year.
