                    ...
                    <div class="rts-fee-chart__tab">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="grade-tution-2-tab" data-bs-toggle="tab" data-bs-target="#grade-tution-3" type="button" role="tab" aria-controls="grade-tution-3" aria-selected="false">2019 - 2020</button>
                                <button class="nav-link" id="grade-tution-2-tab" data-bs-toggle="tab" data-bs-target="#grade-tution-4" type="button" role="tab" aria-controls="grade-tution-4" aria-selected="false">2018 - 2019</button>
                                <button class="nav-link" id="grade-tution-2-tab" data-bs-toggle="tab" data-bs-target="#grade-tution-5" type="button" role="tab" aria-controls="grade-tution-5" aria-selected="false">2017 - 2018</button>
                            </div>
                        </nav>
                    </div>
