    ...
    <div class="container mt-6">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('/research/publication-details')}}">Consultancy Details</a></li>
        ...
        <div class="admission-content-top">
            <div class="application-deadline">
                <h5 class="rts-section-title animated fadeIn">Consultancy Details - {{ $departmentName }}</h5>
